// components/EnhancedBookingButton.jsx
// Drop-in replacement for existing booking buttons with credit functionality

import React, { useState } from 'react';
import { useCredits } from '../hooks/useCredits';

export const EnhancedBookingButton = ({ 
  classId, 
  user, 
  children, 
  className = "",
  ...
  const handleClick = async () => {
    if (!user) {
      // Trigger your existing auth flow
          ...
          <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            ...
            <div className="space-y-3">
              <button
                onClick={() => {
                  setShowModal(false);
                  // Handle credit purchase - you can customize this
              ...
              <button
                onClick={() => {
                  setShowModal(false);
                  // Handle plan upgrade - you can customize this
